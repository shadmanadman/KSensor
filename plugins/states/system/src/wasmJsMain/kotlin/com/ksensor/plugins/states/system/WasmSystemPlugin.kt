...
/**
 * No-op SystemPlugin for the web (Wasm) target. KSensor has no web (Wasm) sensor
 * backend yet, so observations emit nothing and state values are placeholders.
 */
class WasmSystemPlugin : SystemPlugin {
...
actual fun createSystemPlugin(): SystemPlugin = WasmSystemPlugin()
