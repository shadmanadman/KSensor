...
/**
 * No-op LifecyclePlugin for the desktop (JVM) target. KSensor has no desktop (JVM) sensor
 * backend yet, so observations emit nothing and state values are placeholders.
 */
class JvmLifecyclePlugin : LifecyclePlugin {
...
actual fun createLifecyclePlugin(): LifecyclePlugin = JvmLifecyclePlugin()
