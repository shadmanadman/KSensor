...
/**
 * No-op PositioningPlugin for the desktop (JVM) target. KSensor has no desktop (JVM) sensor
 * backend yet, so observations emit nothing and state values are placeholders.
 */
class JvmPositioningPlugin : PositioningPlugin {
...
actual fun createPositioningPlugin(): PositioningPlugin = JvmPositioningPlugin()
