...
/**
 * The web (Wasm/JS) target has no runtime permission model for these sensors,
 * so every permission is treated as granted.
 */
internal class WasmPermissionHandler : PermissionHandler {
...
actual fun createPermissionHandler(): PermissionHandler = WasmPermissionHandler()
